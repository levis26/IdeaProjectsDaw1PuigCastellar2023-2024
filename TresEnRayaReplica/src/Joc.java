...
public class Joc {
    ...
    public boolean comprovarFila(int fila, char simbol){
    ...
    public boolean comprovarColumna(int columna, char simbol){
    ...
    public boolean comprovarDiagonalPrincipal(char simbol){
        for (int i = 0; i <= taulell.length - 3; i++ ){
            for (int j = 0; j <= taulell.length - 3; j++){
    ...
    public boolean comprovarDiagonalSecundaria(char simbol){
        for (int i = 0; i <= taulell.length - 3; i++){
